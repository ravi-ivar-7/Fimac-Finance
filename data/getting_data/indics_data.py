...
class index_data:
    ...
    def fetch_index_from_nse(self,index_symbol):
        ...
        res=self.session.get(self.url+index_symbol,timeout=10) #storing response we get from nse on sending url
...
if __name__=='__main__':
    ...
    obj=index_data()
    data=obj.fetch_index_from_nse('NIFTY 50')
    print(data.iloc[2])
